...
export async function generateMetadata({ params }: PredioPageProps) {
...
export default function PredioPage({ params }: PredioPageProps) {
  ...
  // Filtrar bitácora por predioId y ordenar por fecha descendente
  ...
  // Imágenes de la galería desde los datos del predio
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mb-8">
        ...
        <MapaInteractivo lat={predio.ubicacion.lat} lng={predio.ubicacion.lng} nombre={predio.nombre} />
      </div>
